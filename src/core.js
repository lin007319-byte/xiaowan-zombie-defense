(function (root, factory) {
  ...
  const PLANTS = {
    ...
    frost: { id: "frost", name: "寒冰豌豆", short: "寒冰", cost: 150, cooldown: 6, body: "shooter", gene: "frost", hp: 300, damage: 20, interval: 1.5, color: "#70d7e8" },
    ...
    mushroom: { id: "mushroom", name: "星光菇", short: "星菇", cost: 75, cooldown: 4, body: "shooter", gene: "pierce", hp: 300, damage: 13, interval: .85, color: "#b98cff" },
    cactus: { id: "cactus", name: "尖刺仙人掌", short: "仙人掌", cost: 100, cooldown: 5, body: "shooter", gene: "crit", hp: 300, damage: 28, interval: 1.5, color: "#59bd74" },
    ...
    bamboo: { id: "bamboo", name: "竹筒连弩", short: "竹弩", cost: 150, cooldown: 6, body: "shooter", gene: "multishot", hp: 300, damage: 18, interval: 1.2, color: "#77c65d" },
    lotus: { id: "lotus", name: "治愈莲花", short: "莲花", cost: 100, cooldown: 6, body: "producer", gene: "heal", hp: 300, interval: 8, color: "#f39ac2" },
